...
class Solver(object):
    ...
    def Simult3(self,op_new,ob_fixed,op_c,l_cr,l_rod,alfa):
        try:
        # Try two initial starting guesses
            ...
            f3 = (oc1x - ob_fixed[0])*(op_c[0]-op_new[0]) + (oc1y - ob_fixed[1])*(op_c[1]-op_new[1]) + (oc1z - ob_fixed[2])*(op_c[2]-op_new[2]) - 0
    ...
    def mainsolver(self,ob_axis,ob_fixed,op_c,op_new,l_cr,l_rod,alfa):
        ...
        for i in xrange(3):
            ...
            sol1 = []
            sol1 =  self.Simult3(op_new[counter,:],ob_fixed[counter,:],op_c,l_cr,l_rod,alfa)
            ...
            sol2 = []    
            sol2  =  self.Simult3(op_new[counter,:],ob_fixed[counter,:],op_c,l_cr,l_rod,alfa)
    ...
    def plotarr1(self,ocn,pivot_arr,ax):
        ...
        x1 = [ocn[0],pivot_arr[0]]
        print x1
        print 'stop'
        
        y1 = [ocn[1],pivot_arr[1]]
        print y1
        print 'stop'
        z1 = [ocn[2],pivot_arr[2]]
        print z1
        print 'stop'
...
point_gen = [[0,0,0,0,0,350],[10,0,0,0,0,350],[0,0,0,100,0,350],[0,0,0,0,0,450]]
...
for i in  xrange(len(point_gen)):
    ...
    invkinsol_1 = invkin.mainsolver(ob_axis,ob_fixed,op_c,op_new,l_cr,l_rod,alfa)
